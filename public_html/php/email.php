...
try {
	 ...
	 **/
	$recipients = ["ddenzfong@gmail.com" => "RPG Contact"];
	...
	echo "<div class=\"alert alert-danger\" role=\"alert\"><strong>Oh s</strong> Unable to send email: " . $exception->getMessage() . "</div>";
}